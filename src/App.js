  ...
  render() {
    return (
      <div>
        ...
        <TextArea>
          "Avocado has a rich, buttery and creamy flavor. Depending on what cultivar it is, the avocado can have hints of sweetness as well as a mild, earthy vegetable taste. When it is fully ripe, the avocado can have a delicate, hearty flavor."<br />-&nbsp;
